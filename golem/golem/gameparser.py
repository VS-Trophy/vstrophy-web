from .items import MatchItemVST,  RosterItemVST, RosterSpotItemVST, OffensivePlayerPerformanceItemVST
...
def create_offense_roster_spot(player_row):
    ...
    performance = OffensivePlayerPerformanceItemVST(
        points=float(player_row.css("span.playerTotal::text").get().replace("-","0")),
        pass_yds=float(player_row.css("span.statId-5::text").get().replace("-","0")),
        pass_tds=int(player_row.css("span.statId-6::text").get().replace("-","0")),
        pass_ints=int(player_row.css("span.statId-7::text").get().replace("-","0")),
        rush_yds=float(player_row.css("span.statId-14::text").get().replace("-","0")),
        rush_tds=int(player_row.css("span.statId-15::text").get().replace("-","0")),
        rec_yds=float(player_row.css("span.statId-21::text").get().replace("-","0")),
        rec_tds=int(player_row.css("span.statId-22::text").get().replace("-","0")),
        fum_tds=int(player_row.css("span.statId-29::text").get().replace("-","0")),
        two_pts=int(player_row.css("span.statId-32::text").get().replace("-","0")),
        fum_lost=int(player_row.css("span.statId-30::text").get().replace("-","0"))
    )
